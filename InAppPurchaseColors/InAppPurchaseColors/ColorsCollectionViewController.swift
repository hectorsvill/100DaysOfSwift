...
extension ColorsCollectionViewController: SKPaymentTransactionObserver {
    ...
    func paymentQueue(_ queue: SKPaymentQueue, updatedTransactions transactions: [SKPaymentTransaction]) {
        transactions.forEach {
            ...
            case .deferred: print("deferred: ", $0.description)
...
extension ColorsCollectionViewController {
    func purchaseAllColors() {
        if SKPaymentQueue.canMakePayments() {
            ...
            let ac = view.alert(tile: "Error", message: "This account can't make payments")
